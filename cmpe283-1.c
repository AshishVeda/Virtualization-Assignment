...
struct capability_info procbased2[31] =
{
	...
	{ 30, "VMM_BUS_LOCK_DETECTION"},
	{ 31, "INSTRUCTION_TIMEOUT"},
};


struct capability_info exi[18] =
{
	...
	{ 28, "LOAD_CET_STATE"},
	{ 29, "LOAD_PKRS"},
	{ 30, "SAVE_IA32_PER_GLOBAL_CTL"},
	{ 31, "ACTIVATE_SECONDARY_CONTROLS"},
};


struct capability_info entry[14] =
{
...
struct capability_info procbased3[6] =
{
	{ 0, "LOADIWKEY_EXITING" },
	{ 1, "ENABLE_HLAT" },
	{ 2, "EPT_PAGING_WRITE_CONTROL" },
	{ 3, "GUEST_PAGING_VERIFICATION" },
	{ 4, "IPI_VIRTUALIZATION" },
	{ 5, "VIRTUALIZE IA32_SPEC_CTRL" },
};
